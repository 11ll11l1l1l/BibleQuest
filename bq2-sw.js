const CACHE='biblequest-clean-v1';
const CORE=['./','./index.html','./bq2.css','./bq2-data.js','./bq2.js','./bq2-reader.js','./bq2-games.js','./bq2-grow.js','./data/questions.js','./app-icon.svg'];
...
self.addEventListener('fetch',e=>{
  ...
  if(url.pathname.includes('/data/packs/bible/')){
