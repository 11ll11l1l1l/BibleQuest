const CACHE='biblequest-clean-v3';
const CORE=['./','./index.html','./bq2.css','./bq2-data.js','./bq2.js','./bq2-reader.js','./bq2-games.js','./bq2-grow.js','./bq2-study.js','./bq2-bookquiz.js','./data/questions.js','./data/stories.js','./data/packs/manifest.json','./app-icon.svg'];
...
self.addEventListener('fetch',e=>{
  ...
  if(url.pathname.includes('/data/packs/bible/')||url.pathname.includes('/data/packs/tagalog/')||url.pathname.includes('/data/packs/questions/')){
