(() => {
  ...
  async function check(){
    ...
    if(!session?.user){
      resolved=true;role='';removeInjected();stopRetry();return true;
    }
  ...
  // Account and Home surfaces render dynamically. Reconcile only on their known
  // lifecycle/user-entry signals instead of observing the entire document forever.
