(() => {
  ...
  // Leaderboard rendering now lives in community.js. Keeping this module focused on
  // converting learning/couples progress into dated score events avoids duplicate UI
  // implementations and keeps all eight ranking lanes in one canonical renderer.
  window.BQCommunityBridge={appDelta,couplesDelta,LANES};
})();
