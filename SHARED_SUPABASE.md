...
Cloudflare Pages is the primary BibleQuest web host.

- Stable project URL: `https://biblequest-7th.pages.dev/`
- Cloudflare deployment previews may use `https://<deployment>.biblequest-7th.pages.dev/`.
- The legacy GitHub Pages route may remain as a compatibility redirect/fallback but is not the canonical production URL.
...
- Site URL: `https://biblequest-7th.pages.dev/`
- Redirect URL: `https://biblequest-7th.pages.dev/**`
- Redirect URL for Cloudflare deployment previews when preview recovery is desired: `https://*.biblequest-7th.pages.dev/**`
