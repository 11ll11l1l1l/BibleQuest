...
const CORE=['./','./index.html','./transform.html','./styles.css','./tutorial.css','./mobile-readability.css','./transformation-v2.css','./app.js','./transform-launcher.js','./pwa-runtime.js','./onboarding-tutorial.js','./tutorial-launcher.js','./assets/tutorial-trainer-sprite.webp','./manifest.webmanifest','./app-icon.svg'];
