...
const SHELL=['./','./index.html','./styles.css','./decks.css','./reader.css','./sequence.css','./storyjourney.css','./app.js','./reader.js','./sequence.js','./storyjourney.js','./manifest.webmanifest'];
