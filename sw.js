...
const CORE=['./','./index.html','./styles.css','./app.js','./pwa-runtime.js','./operational-hardening.js','./onboarding-tutorial.js','./manifest.webmanifest','./app-icon.svg'];
