const CACHE='biblequest-v48';
const SHELL=['./','./index.html','./app-icon.svg','./assets/bq-pinoy-japan-hero.svg','./assets/tutorial-trainer-sprite.webp','./styles.css','./decks.css','./reader.css','./japanese-learning.css','./sequence.css','./storyjourney.css','./growth.css','./growth-nudge.css','./learning-engine.css','./open-review.css','./ui-enhancements.css','./extra-games.css','./couples.css','./community.css','./group-play.css','./cloud.css','./account.css','./notes.css','./innovation.css','./modern-home.css','./completion.css','./kawaii-polish.css','./round2-polish.css','./pinoy-hero.css','./journey-loop.css','./journey-groups.css','./release-hardening.css','./mobile-production.css','./tutorial.css','./transform-quarantine.css','./data/doctrinal-safety.js','./data/doctrinal-context.js','./runtime-safety.js','./app.js','./reader.js','./translations.js','./japanese-learning.js','./sequence.js','./storyjourney.js','./growth.js','./growth-nudge.js','./learning-engine.js','./open-review.js','./extra-games.js','./couples.js','./community.js','./community-bridge.js','./cloud-config.js','./account.js','./onboarding-tutorial.js','./tutorial-launcher.js','./password-recovery.js','./admin-link.js','./personality-profile.js','./signup-enhancements.js','./notes.js','./cloud-copy.js','./cloud.js','./group-play.js','./live-rooms.js','./innovation-suite.js','./workspace.js','./couple-cloud.js','./context-lab.js','./assignment-center.js','./assignment-push.js','./presence.js','./avatar-vault.js','./source-labels.js','./ui-taglish.js','./account-taglish.js','./modern-home.js','./pinoy-hero.js','./journey-groups.js','./journey-loop.js','./journey-accessibility.js','./journey-cloud-sync.js','./engagement-v3.js','./frontpage-daily.js','./quest-media.js','./release-hardening.js','./mobile-production.js','./transform-quarantine.js','./pwa-runtime.js','./data/questions.js','./data/connections.js','./data/packs/manifest.json','./data/packs/context/manifest.json','./manifest.webmanifest'];
const CORE=['./','./index.html','./styles.css','./tutorial.css','./transform-quarantine.css','./app.js','./transform-quarantine.js','./pwa-runtime.js','./onboarding-tutorial.js','./tutorial-launcher.js','./assets/tutorial-trainer-sprite.webp','./manifest.webmanifest','./app-icon.svg'];
