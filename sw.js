...
const CORE=['./','./index.html','./transform.html','./psychometrics.html','./psychometrics.css','./psychometrics-data-neo.js','./psychometrics-data-via.js','./psychometrics-suite.js','./psychometrics-christian.js','./psychometrics-insight.js','./psychometrics-polish.js','./styles.css','./tutorial.css','./mobile-readability.css','./transformation-v2.css','./app.js','./transform-launcher.js','./pwa-runtime.js','./onboarding-tutorial.js','./tutorial-launcher.js','./assets/tutorial-trainer-sprite.webp','./manifest.webmanifest','./app-icon.svg'];
