const CACHE='biblequest-v13';
const SHELL=['./','./index.html','./styles.css','./decks.css','./reader.css','./sequence.css','./storyjourney.css','./transformation.css','./transformation-taglish.css','./growth.css','./growth-nudge.css','./learning-engine.css','./open-review.css','./ui-enhancements.css','./extra-games.css','./couples.css','./app.js','./reader.js','./sequence.js','./storyjourney.js','./transformation.js','./transformation-taglish.js','./growth.js','./growth-nudge.js','./learning-engine.js','./open-review.js','./extra-games.js','./couples.js','./source-labels.js','./ui-taglish.js','./data/questions.js','./data/connections.js','./data/packs/manifest.json','./manifest.webmanifest'];
