...
Known-good frozen releases extend through `release/v3.40-community-bridge` at `fca8edd2e18015b246aced2dff6590308ff6bde2`; exact v3.40 bookkeeping run `34340610144` passed the complete accumulated suite against that SHA before freeze. #67 Community Bridge is Verified and #65 Encouragements is Regression-tested. Current strict parity is 67/100 and official regression stability is 66/100. #68 Presence is the next dependency-safe milestone. Production v2, `main`, production Supabase, and production Cloudflare remain isolated.
