...
if(!failures.length){
  ...
  if(!inventory.includes('| 98 | Offline shell | Yes | Clean | Regression-tested | reload offline after first load; bounded shell cache; no pack/API/probe interception; 390px offline reload |'))fail('#98 must advance to Regression-tested after surviving the complete #99 suite.');
