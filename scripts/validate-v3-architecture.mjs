...
const required=[
  ...
  'src/features/study/content.js','src/features/study/index.js','src/features/deep-questions/content.js','src/features/deep-questions/index.js','src/features/story-journey/content.js','src/features/story-journey/index.js','src/features/wisdom-situations/content.js','src/features/wisdom-situations/index.js','src/features/adaptive-learning/index.js','src/features/transform/content.js','src/features/transform/index.js','src/features/recordings/index.js','src/features/media-library/index.js','src/features/games/content.js','src/features/games/index.js',
  'src/ui/shell.js','src/ui/app.css','src/ui/reader.css','src/ui/progress.css','src/ui/study.css','src/ui/deep-questions.css','src/ui/story-journey.css','src/ui/wisdom-situations.css','src/ui/adaptive-learning.css','src/ui/daily-mission.css','src/ui/transform.css','src/ui/recordings.css','src/ui/media-library.css','src/ui/games.css',
...
for(const style of['src/ui/app.css','src/ui/reader.css','src/ui/progress.css','src/ui/study.css','src/ui/deep-questions.css','src/ui/story-journey.css','src/ui/wisdom-situations.css','src/ui/adaptive-learning.css','src/ui/daily-mission.css','src/ui/transform.css','src/ui/recordings.css','src/ui/media-library.css','src/ui/games.css'])if(!html.includes(style))fail(`index.html must load ${style}.`);
