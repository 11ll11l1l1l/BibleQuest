...
const required = ['index.html','src/app/bootstrap.js','src/app/router.js','src/app/store.js','src/app/session.js','src/app/account.js','src/core/storage.js','src/core/api.js','src/ui/shell.js','src/ui/app.css','src/features/home/index.js','src/features/account/index.js','FEATURE_INVENTORY_V3.md','DEVELOPMENT_STATUS_V3.md','ARCHITECTURE_V3.md'];
...
console.log('Single boot, router, store/storage, API, session and account-workflow ownership confirmed.');
