...
if(!failures.length){
  ...
  const cardIds=[...content.matchAll(/id:'c(\d{2})'/g)].map(match=>match[1]);if(cardIds.length!==64||cardIds[0]!=='01'||cardIds.at(-1)!=='64')fail('Couples content must retain exactly c01–c64.');
