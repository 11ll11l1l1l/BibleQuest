...
for(const token of['data-assignment-advanced-meta','data-assignment-scheduled','name="quizScore"','name="confirmed"'])if(!ui.includes(token))fail(`Assignments UI missing #74 presentation contract: ${token}`);
if(!ui.includes("tx('assignments.recurrenceNotice')"))fail("Assignments UI missing #74 presentation contract: assignments.recurrenceNotice lookup");
