...
const required=['index.html','classic.html','PARITY_MATRIX.md','bq2.css','bq2-parity.css','bq2-data.js','bq2.js','bq2-reader.js','bq2-games.js','bq2-grow.js','bq2-study.js','bq2-bookquiz.js','bq2-parity.js','bq2-classic-bridge.js','bq2-sw.js','data/questions.js','data/stories.js','data/packs/manifest.json'];
...
for(const file of ['bq2.css','bq2-parity.css','bq2-data.js','bq2.js','bq2-reader.js','bq2-games.js','bq2-grow.js','bq2-study.js','bq2-bookquiz.js','bq2-parity.js'])if(!html.includes(file))fail(`index.html does not reference ${file}`);
...
for(const file of ['bq2-data.js','bq2.js','bq2-reader.js','bq2-games.js','bq2-grow.js','bq2-study.js','bq2-bookquiz.js','bq2-parity.js','bq2-classic-bridge.js','bq2-sw.js']){
...
for(const file of ['classic.html','bq2-parity.css','bq2-parity.js','assets/bq-pinoy-japan-hero.svg'])if(!sw.includes(file))fail(`Clean service worker core missing parity resource: ${file}`);
