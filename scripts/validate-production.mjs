...
run(process.execPath,['tests/production-consistency-static.mjs']);
run(process.execPath,['tests/psychometrics-static-smoke.mjs']);
run(process.execPath,['tests/transform-quarantine-static-smoke.mjs']);
run(process.execPath,['scripts/reference-audit.js']);
