...
if(!failures.length){
  ...
  if(!inventory.includes('| 96 | Operational recovery/error boundary | Yes | Clean basic | Not started |'))fail('#96 must remain Not started until its exact functional candidate passes the complete suite.');
