...
if(!failures.length){
  ...
  for(const item of['open; save state; role/session boundary','Workspace UI/context state','Cloud Notes','Reader','Legacy bookmark/highlight','does **not** invent'])if(!contract.includes(item))fail(`Workspace contract missing recovered boundary: ${item}`);
