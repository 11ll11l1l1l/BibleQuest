...
if(!bootstrap.includes('const vocabulary=createJapaneseVocabularyService({storage})')||!bootstrap.includes('readerPage({reader,vocabulary,furigana})')) fail('Bootstrap must compose vocabulary through Storage and inject it into Reader.');
