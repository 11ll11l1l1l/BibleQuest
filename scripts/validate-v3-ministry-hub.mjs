...
if(!failures.length){
  ...
  for(const item of["import { createMinistryHubService } from './ministry-hub.js'","import { ministryHubPage } from '../features/ministry-hub/index.js'",'createMinistryHubService({congregation})',"'ministry-hub':()=>ministryHubPage",'calendar:()=>calendarPage',"onMinistryHub:()=>router.navigate('ministry-hub')"])if(!bootstrap.includes(item))fail(`Bootstrap missing #76/follow-up composition: ${item}`);
