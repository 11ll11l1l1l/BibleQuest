...
for(const required of ['reset.html','reset.js','password-recovery.js','progress-sync-policy.js','admin.html','admin.js','admin-link.js','admin-operations.html','admin-operations.js','guest-access-hardening.js','transform.html','transform-launcher.js','transformation-v2.js','transformation-v2.css','psychometrics.html','psychometrics-suite.js','content-review.html','content-review.css','content-review.js','content-moderation-runtime.js','content-report.css','content-report.js','content-review-link.js','congregation-recognition.css','congregation-recognition.js','mobile-readability.css','home-professional.css','tests/browser-smoke.mjs','tests/layout-matrix-smoke.mjs','tests/operational-entry-smoke.mjs','tests/navigation-static-smoke.mjs','tests/content-review-static-smoke.mjs','tests/congregation-recognition-static-smoke.mjs','tests/progress-sync-conflict-static.mjs','LICENSE','THIRD_PARTY_NOTICES.md','_headers','_redirects','SHARED_SUPABASE.md','supabase/functions/bq-admin/index.ts','supabase/functions/bq-signup/index.ts','supabase/functions/bq-password-reset/index.ts','supabase/migrations/20260905_account_recovery_code_v2.sql','supabase/migrations/20260905_content_review_and_reports.sql','supabase/migrations/20260905_content_reviewer_member_read.sql'])assert(exists(required),`required release file missing: ${required}`);
...
const doctrinalRuntimeVersion=Number(doctrinalRuntime.match(/(?:const\s+VERSION\s*=|version\s*:)\s*(\d+)/)?.[1]||0);
const doctrinalPackVersion=Number(packManifest.doctrinal_safety_version??packManifest.doctrinal_safety?.version??0);
assert(doctrinalRuntimeVersion>0,'could not resolve runtime doctrinal safety version');
assert(doctrinalPackVersion===doctrinalRuntimeVersion,`DOCTRINAL RELEASE BLOCKER: generated pack policy v${doctrinalPackVersion||'missing'} does not match runtime policy v${doctrinalRuntimeVersion}`);
