...
if(!failures.length){
  ...
  for(const test of['scripts/validate-v3-backup.mjs','tests/v3-backup-edge.mjs','tests/v3-backup-smoke.mjs'])if(!workflowInvokesNode(workflow,test))fail(`Accumulated workflow missing #100 regression: ${test}`);
}
