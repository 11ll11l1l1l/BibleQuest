...
if(!failures.length){
  ...
  if(!inventory.includes('| 100 | Backup/export/import/reset | Yes | Clean | Not started | export → import → state restored |'))fail('#100 must remain Not started until the complete functional gate passes.');
