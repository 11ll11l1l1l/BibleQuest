...
assert.match(legacy,/id="kidBible"[^>]*><b>Bible Who Am I\?<\/b><small>Three clues\. One Bible hero\. Can you guess\?<\/small>/,'Retained v2 Kids Bible launcher contract is missing.');
assert.match(legacy,/querySelector\('#kidBible'\)\.addEventListener\('click',\(\)=>detective\(\)\)/,'Retained v2 must prove Kids Bible delegates to detective().');
...
assert.match(ui,/Three clues\. One Bible hero\. Can you guess\?/,'V3 Kids Bible launcher must preserve the retained description.');
