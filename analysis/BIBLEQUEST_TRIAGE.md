...
- **Investigator 1:** no executable user-facing FAIL was reproduced; successful deployment checks do not prove browser flows; same cloud overwrite remains the only material source-level defect.
