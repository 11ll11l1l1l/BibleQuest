...
// Encouragements, whose authorized V5 genuine-match artwork evolution is
// governed by behavior/accessibility hooks plus the focused V5 artwork
// contract rather than a whole-file byte lock; and Recordings, whose
// intentional merge with Media Library into one Videos page (custom
