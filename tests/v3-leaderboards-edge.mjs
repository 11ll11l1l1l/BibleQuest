...
const memberships=[{congregationId:'c1',roleLabel:'Member',congregation:{name:'Church One'}}];
...
assert.equal(calls[0].since,'2026-09-06T15:00:00.000Z','Recovered week must begin Monday local midnight.');
...
assert.equal(calls[1].since,'2026-09-08T15:00:00.000Z','Recovered today must begin local midnight.');
