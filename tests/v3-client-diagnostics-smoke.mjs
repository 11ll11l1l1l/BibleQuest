...
async function run(){
  ...
  await page.evaluate(async()=>{
    ...
    window.__bqDiagnosticsHarness={build:diagnosticIdentity,navigate:r=>router.navigate(r),unreachable:()=>{reachable=false;now+=6000},destroy:()=>{root.remove();delete window.__bqDiagnosticsHarness}};router.navigate('broken');
  });
