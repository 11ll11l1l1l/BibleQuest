...
try{
  ...
  const pwa=await page.evaluate(async()=>{
    ...
    const required=['./','./index.html','./transform.html','./styles.css','./mobile-readability.css','./transformation-v2.css','./app.js','./transform-launcher.js','./transformation-v2.js','./pwa-runtime.js','./onboarding-tutorial.js','./manifest.webmanifest','./app-icon.svg'];
    const cached={};
  ...
  assert.ok(pwa.version>=52,`expected standalone-Transform/mobile-readability PWA baseline v52+, got v${pwa.version||'missing'}`);
  ...
  console.log('phase: offline standalone Transform');
  ...
  console.log(`PWA offline browser smoke passed · cache v${pwa.version} · standalone Transform, cached Scripture, four-tab shell, offline reload and recovery verified`);
} finally {
