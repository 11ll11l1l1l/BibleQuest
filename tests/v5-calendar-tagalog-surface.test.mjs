...
test('migrated Calendar owner contains no representative rendered English chrome literals', () => {
  for (const leak of ['Month planner','Previous month','Next month','Calendar categories','SELECTED DAY','No events on this day.','Event title','Event date','Repeat weekly for extra weeks','Save changes','Add event','Next 30 days','Nothing in the next 30 days.','Shared event updated.','Event shared with your congregation.','Could not add that event.']) {
