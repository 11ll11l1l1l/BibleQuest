...
assert.match(doctrinalAudit,/committed question\/quarantine file is missing from manifest\.question_books/,'unmanifested doctrinal corpus files must block release');
