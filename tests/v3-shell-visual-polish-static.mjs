...
const firstFeaturePolish='<link rel="stylesheet" href="src/ui/account-visual-polish.css">';
...
assert(index.indexOf(baseLink)<index.indexOf(polishLink),'Shell visual polish must load after app.css.');
assert(index.indexOf(polishLink)<index.indexOf(firstFeaturePolish),'Shell visual polish must load before feature-local visual overlays.');
