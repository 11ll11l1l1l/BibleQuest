...
const symbols=['workspace','notifications','community','ministry','review','couples','couples-cloud','journey-groups','team','accessibility','install','backup','mission','challenge','calendar','congregation','share'];
