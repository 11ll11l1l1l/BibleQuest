...
if(!failures.length){
  ...
  if(themeIndex<0||themeIndex<accessibilityIndex)fail('Theme layer must load after accumulated feature/accessibility CSS so the final palette is explicit and reversible.');
}
