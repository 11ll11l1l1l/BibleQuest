...
const memoryView=read('src/features/games/views/launcher-memory.js');
...
assert(uiSurface.includes("data-memory-index")&&uiSurface.includes("data-memory-complete"),'Memory Meadow UI surfaces must remain present.');
