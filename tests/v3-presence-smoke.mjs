...
async function run(){
  ...
  const result=await page.evaluate(async()=>{
    ...
    const session={getState:()=>sessionState},congregation={list:()=>[{congregationId:'c1',userId:'u1'}],load:async()=>[{congregationId:'c1',userId:'u1'}],can:id=>id==='c1',getActive:()=>({congregationId:'c1',userId:'u1'})};
