...
function start(){
  ...
  const routes=Object.freeze({
    ...
    mission:()=>missionPage({mission,onBack:()=>router.navigate('more'),onReview:()=>router.navigate('open-review'),onStudy:()=>router.navigate('study')}),
