...
function start(){
  ...
  const routes=Object.freeze({
    ...
    'journey-groups':()=>journeyGroupsPage({journeyGroups,onBack:()=>router.navigate('more'),onAccount:()=>router.navigate('account')}),
    ...
    more:()=>morePage({pwaInstall,onCouplesFamily:()=>router.navigate('couples-family'),onCouplesCloud:()=>router.navigate('couples-cloud'),onCongregation:()=>router.navigate('congregation'),onJourneyGroups:()=>router.navigate('journey-groups'),onBackup:()=>router.navigate('backup')}),
