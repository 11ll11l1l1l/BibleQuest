...
export const STYLES = Object.freeze([
  ...
  freezeStyle({ id: 'scroll', icon: '📜', name: 'Scroll Keeper', req: 'Study 100 recall cards', available: false, needsOwner: 'recall-pack-reps', test: () => false, progress: () => 'Not yet available' }),
  ...
  freezeStyle({ id: 'couple', icon: '💞', name: 'Growing Together', req: 'Complete 10 couples conversations', available: false, needsOwner: 'couples-history-count', test: () => false, progress: () => 'Not yet available' }),
  ...
  freezeStyle({ id: 'world', icon: '🌏', name: 'Bible World Traveler', req: 'Reach 50% in every Journey region', available: false, needsOwner: 'journey-region-mastery', test: () => false, progress: () => 'Not yet available' }),
  ...
  freezeStyle({ id: 'moon', icon: '🌙', name: 'Moonlight Reader', req: 'Study 250 recall cards', available: false, needsOwner: 'recall-pack-reps', test: () => false, progress: () => 'Not yet available' }),
  freezeStyle({ id: 'fuji', icon: '🗻', name: 'Fuji Explorer', req: 'Reach 100% exploration in one Journey region', available: false, needsOwner: 'journey-region-mastery', test: () => false, progress: () => 'Not yet available' }),
  freezeStyle({ id: 'tea', icon: '🍵', name: 'Tea Garden Scholar', req: 'Complete 10 leader assignments', available: false, needsOwner: 'assignment-completion-count', test: () => false, progress: () => 'Not yet available' })
]);
