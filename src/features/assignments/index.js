...
function detailView(state){
  ...
  const leaderNote=readOnly?'<p class="bq-form-message">This assignment surface is read-only for ministry roles. Publishing, review and administration belong to later assignment/ministry milestones.</p>':'';
