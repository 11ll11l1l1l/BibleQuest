...
const LEARN_COPY=Object.freeze({
  en:Object.freeze({
    ...
    'learn.wisdom':'Wisdom Situations','learn.wisdom.detail':'72 realistic cases · difficulty 4–8 · four plausible judgments · Scripture',
    'learn.exploreGroup':'EXPLORE & REVIEW','learn.world':'Bible World','learn.world.detail':'Nine story regions · exploration evidence · Scripture routes','learn.explorer':'Characters & Places','learn.explorer.detail':'People · places · non-repeating clues · Scripture references',
  ...
  tl:Object.freeze({
    ...
    'learn.wisdom':'Mga Sitwasyon ng Karunungan','learn.wisdom.detail':'72 makatotohanang sitwasyon · antas 4–8 · apat na kapani-paniwalang pasya · Kasulatan',
    'learn.exploreGroup':'TUKLASIN AT BALIKAN','learn.world':'Mundo ng Biblia','learn.world.detail':'Siyam na rehiyon ng kuwento · ebidensya ng pagtuklas · mga ruta sa Kasulatan','learn.explorer':'Mga Tauhan at Lugar','learn.explorer.detail':'Mga tao · lugar · hindi umuulit na pahiwatig · mga sanggunian sa Kasulatan',
  ...
  ceb:Object.freeze({
    ...
    'learn.wisdom':'Mga Sitwasyon sa Kaalam','learn.wisdom.detail':'72 ka realistiko nga sitwasyon · lebel 4–8 · upat ka makatarunganong paghukom · Kasulatan',
    'learn.exploreGroup':'SUSIHI UG BALIKA','learn.world':'Kalibutan sa Bibliya','learn.world.detail':'Siyam ka rehiyon sa sugilanon · ebidensya sa pagsusi · mga ruta sa Kasulatan','learn.explorer':'Mga Tawo ug Lugar','learn.explorer.detail':'Mga tawo · lugar · dili mag-usab nga mga timailhan · mga reperensya sa Kasulatan',
