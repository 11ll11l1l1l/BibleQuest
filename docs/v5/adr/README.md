# BibleQuest V5 Architecture Decision Records

V5 is explicitly allowed to change architecture. ADRs make those intentional changes recoverable and prevent chat/temporary implementation details from becoming invisible architecture policy.
...
- ADR-0001 — V5 build/client architecture: Vite + TypeScript and selected component migration strategy.
