...
- A real invocation with controlled non-production Supabase credentials that reaches the final PASS line is **real Supabase Auth E2E evidence** for the Phase 2 email-change acceptance item.
