...
Final acceptance note: this sweep provides STATIC + BROWSER-AUTO evidence for the deferred Section G verification debt on one exact candidate. It does not substitute for Phase 5's separate real no-network Scripture reopening requirement, nor for BACKEND-E2E or DEVICE/FIELD gates elsewhere in V5.
